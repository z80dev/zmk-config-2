;; Sample ZMK configuration in s-expression form
;; This configuration will be loaded by the compiler (corne.ss)

;; Header configuration
(header
 ((copyright "Copyright (c) 2025 z80")
  (license "MIT")
  (includes ("behaviors.dtsi"
             "dt-bindings/zmk/bt.h"
             "dt-bindings/zmk/keys.h"
             "dt-bindings/zmk/mouse.h"))))
...
;; Matrix transform setting
(matrix_transform "five_column_transform")
